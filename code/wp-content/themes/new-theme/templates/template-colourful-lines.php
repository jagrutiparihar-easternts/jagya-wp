<?php 
/*
Template Name: Colourful Lines
*/
?>
<?php get_header(); ?>

<div id="fullpage">
      <div class="section color-line-well" id="section0">
        <div
          ...
          <div class="row">
            <div class="col-xl-7">
              <div class="row">
                ...
                <div class="col-xl-8">
                  <div
                    class="content-well main-heading wow fadeInDown animated"
                  >
                    <h1>COLOURFUL LINES</h1>
                  </div>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-xl-8">
                  ...
                  >
                    <p>
                      Users plays very important role in designing the spaces
              ...
              <div class="row">
                <div class="col-xl-4">
                  <div class="wow fadeInUp animated" data-wow-delay="400ms">
                    <img
